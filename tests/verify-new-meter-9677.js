...
//
// ★★何と何を比べているか（2026-08-27 実測・指示役の指示で1行）★★
//   ★比べているのは 距離の「物差し」が違う2つです★
//     こちら側 … ★今のエンジンが出す距離 9,065.75m★
//                （＝平滑した生GPSの弦。smoothedRawMode: true・pipeline-distance.js:271）
//     あちら側 … ★TARGET 9,220.9m★
//                （＝★道路の当てはめ（Viterbi確定snap）で出した距離★・2026-05-31 に置いた基準）
//   ★物差しは 2026-06-06 に 変わりました★（司さん裁定「生GPS寄せ+過大対策」・同:257）
//   ★でも 基準の数字は 2026-05-31 のまま★です。だから ★-155.14m（-1.68%）★ で赤になります。
//   ★設計の注記が言っている事とも 向きが合っています★
//     同:264「★平滑弦 ≤ 生弦★（平滑は短縮方向）」／同:262「全fixtureで 過大ゼロ + 精度 -0.3〜-1.4%」
//   ⇒★エンジンの不具合ではなく「基準が 古い物差しのまま」★という形です。
//   ⇒★どうするかは 指示役の裁定待ち★（今の物差しで基準を置き直す／別の見張りに畳む／消す）。
//     ★私は 何も直していません／基準も動かしていません★（距離・課金なので）。
//

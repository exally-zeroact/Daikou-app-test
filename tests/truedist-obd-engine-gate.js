#!/usr/bin/env node
'use strict';
// ★物差し★ 2026-08-28 … ★独自の線です（どちらのモードとも 違います）★
//   ・この gate の 過大しきい ＝ ★真距離 +5%（--eps 既定 0.05）★
//   ・タクシー認定モード（過大不可・ε0.5%）より ★緩い★
//   ・代行モードの天井（DM Light/タイヤ真値 +0.5〜6%）より ★わずかに 厳しい★
//   ⇒ ここが赤でも ★タクシー認定アウトとは 限らず★、緑でも ★代行の天井内とは 限りません★。
/* ============================================================================

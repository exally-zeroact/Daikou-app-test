...
// ★2026-08-29: ★2本とも 直したので 空になりました★
//   ・verify-display-frame-clamp … ★1フレームの前進に 10m の上限を 付けた★
//     （前は 時間だけ 頭打ち＝速い時に 22.7m 飛んでいた／司さんの契約は「10m 単位で 動く」）
//   ・verify-display-gap-recovery … ★追従上限の下限を 30 → 25 m/s に 下げた★
//     （止まった後でも 108km/h まで 許していて 29.70m/s で「ドン」と 動いていた）
//   ★距離（distance_m）には 触っていません★（verify-9677／gate-road／k-neverover は 前後とも 戻り値0）
//   ⇒ ★増えたら ここに 足す★（本数が 変わると 下の見張りが 赤になります）
const MADA = {};

...
(function (global) {
  ...
  const DATA_REGISTRY = {
    ...
    global: [
      ...
      {
        url: '/data/pref-borders-jp.js',
        globalKey: 'PREF_BORDERS_JP',
        target: 'worker',
        msgType: 'loadPrefBorders',
      },
      {
        url: '/data/highways-jp.js',
        globalKey: 'HIGHWAYS_JP',
        target: 'worker',
        msgType: 'loadHighways',
      },
      {
        url: '/data/coastline-jp.js',
        globalKey: 'COASTLINE_JP',
        target: 'worker',
        msgType: 'loadCoastline',
      },
      {
        url: '/data/railways-jp.js',
        globalKey: 'RAILWAYS_JP',
        target: 'worker',
        msgType: 'loadRailways',
      },
      ...
      // 任意 (worker 接続)
      {
        url: '/data/road-graph-backbone-jp.js',
        globalKey: 'ROAD_GRAPH_BACKBONE_JP',
        target: 'worker',
        msgType: 'loadBackbone',
        optional: true,
      },
      {
        url: '/data/dem-jp.js',
    ...
    perPref: [
      ...
      // 補助データ (main 接続)
      {
        ...
        globalKeyFn: function (pref) {
          return 'TUNNELS_' + _prefUpper(pref);
        },
        target: 'main',
      },
      {
        ...
        globalKeyFn: function (pref) {
          return 'BRIDGES_' + _prefUpper(pref);
        },
        target: 'main',
      },
      ...
      // attrs / flood / jizen / yobo (main 接続・任意・無くても稼働)
      {
        ...
        globalKeyFn: function (pref) {
          return 'ROAD_ATTRS_' + _prefUpper(pref);
        },
        target: 'main',
        optional: true,
      },
      {
        ...
        globalKeyFn: function (pref) {
          return 'ROAD_FLOOD_' + _prefUpper(pref);
        },
        target: 'main',
        optional: true,
      },
      {
        ...
        globalKeyFn: function (pref) {
          return 'ROAD_JIZEN_' + _prefUpper(pref);
        },
        target: 'main',
        optional: true,
      },
      {
        ...
        globalKeyFn: function (pref) {
          return 'ROAD_YOBO_' + _prefUpper(pref);
        },
        target: 'main',
        optional: true,
      },
